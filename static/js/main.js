...
var TRANSLATIONS = {
  ...
  fil: {
    ...
    home_kicker:      'Contactless Supplementary Meat Assessment',
    ...
    result_fresh_explanation:      'Mukhang sariwa ang karne.',
    result_suspicious_explanation: 'Maging maingat.',
    result_stale_explanation:      'Huwag bilhin ang karneng ito.',
    result_fresh_rec:              'Siguraduhin na normal ang amoy at hindi mukhang malagkit bago ito bilhin.',
    result_suspicious_rec:         'Tignan kung ito ay may masangsang na amoy at kakaibang tekstura. Kung nag-aalangan, mabuting tumingin na lamang sa ibang bilihan.',
  ...
  en: {
    ...
    result_fresh_explanation:      'This meat appears visually fresh.',
    result_suspicious_explanation: 'Exercise caution.',
    result_stale_explanation:      'Avoid buying this meat.',
    result_fresh_rec:              'Ensure that the meat has a normal odor and has no surface slime before purchasing.',
    result_suspicious_rec:         'Closely inspect the meat for any off-odors or slimy texture. If unsure, consider buying from another stall.',
